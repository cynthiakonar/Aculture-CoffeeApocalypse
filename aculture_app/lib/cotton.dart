    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 63.0, start: 32.0),
            Pin(size: 15.0, middle: 0.7591),
            child: Text(
              'Pesticides',
              style: TextStyle(
                fontFamily: 'Montserrat',
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Text(
                    'deep black soils (regur) of the Deccan and the Malwa\nPlateaus. alluvial soils of the Satluj-Ganga Plain and red\nand laterite soils of the peninsular regions.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Text(
                    'it is sown in April-May and is harvested in December-January\nbefore the winter frost.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(start: 32.0, end: 25.0),
            Pin(size: 45.0, middle: 0.6245),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 26.0, end: 0.0),
                  child: Text(
                    'requires uniformly high temperature between 21°C and 30°C.\nretarded when the temperature falls below 20°C. ',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 26.0, end: 0.0),
                  child: Text(
                    'Gujarat, Maharashtra, Telangana, Punjab, Haryana, Rajasthan,\nAndhra Pradesh, Karnataka and Tamil Nadu.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(size: 248.0, start: 32.0),
            Pin(size: 26.0, middle: 0.8117),
            child: Text(
              'Pyrethroids followed by Organophosphates and\npesticides mixtures',
              style: TextStyle(
                fontFamily: 'Montserrat',
                fontSize: 10,
                color: const Color(0xff004869),
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              '(MSP) has been announced as Rs 5726 per quintal for this crop year\n2021-2022 from Rs 5515  per quintal.',
                          style: TextStyle(
                            fontSize: 9,

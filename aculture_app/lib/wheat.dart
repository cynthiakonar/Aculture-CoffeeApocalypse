    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 30.0, end: 47.0),
            Pin(size: 26.0, middle: 0.4427),
            child: Text(
              'clay loam or loam texture, good structure and moderate\nwater holding capacity are ideal for wheat cultivation.',
              style: TextStyle(
                fontFamily: 'Montserrat',
                fontSize: 10,
                color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 39.0, middle: 0.5356),
            child: Text(
              'Usually sown from months of September to December in\nvarious states of India depending upon the suitable climate,\nand the harvesting is done from February to May',
              style: TextStyle(
                fontFamily: 'Montserrat',
                fontSize: 10,
                color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(size: 118.0, start: 30.0),
            Pin(size: 15.0, middle: 0.5947),
            child: Text(
              'Climate Conditions',
              style: TextStyle(
                fontFamily: 'Montserrat',
          ...
          Pinned.fromPins(
            Pin(start: 30.0, end: 53.0),
            Pin(size: 26.0, middle: 0.6272),
            child: Text(
              'Ideally should be the winter temperature of 10°C-15°C and\nsummer temperature of 21°C-26°C',
              style: TextStyle(
                fontFamily: 'Montserrat',
                fontSize: 10,
                color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(start: 30.0, end: 54.0),
            Pin(size: 52.0, middle: 0.7368),
            child: Text(
              'Grown mainly in the northern states, with Uttar Pradesh\nbeing the top-most contributor of wheat with a total\nproduction of 25.22 million tonnes, followed by Punjab\n(15.78 MT) and Madhya Pradesh (14.18 MT)',
              style: TextStyle(
                fontFamily: 'Montserrat',
                fontSize: 10,
                color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(size: 265.0, start: 30.0),
            Pin(size: 26.0, end: 134.0),
            child: Text(
              'organochlorines, organophosphates, and synthetic\npyrethroids.',
              style: TextStyle(
                fontFamily: 'Montserrat',
                fontSize: 10,
                color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  TextSpan(
                    text: 'the estimated yield of wheat was 3400 kg/hectare',
                    style: TextStyle(
                      fontWeight: FontWeight.w500,
                    ),
                  ),
                  TextSpan(
                    text:
                        '\nMSP has been announced as Rs 2,015 per quintal for this crop\nyear from Rs 1,975 per quintal in the 2020-21 crop year.',
                    style: TextStyle(
                      fontSize: 9,

...
class iPhoneXXS11Pro7 extends StatelessWidget {
  iPhoneXXS11Pro7({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 28.5, end: 41.5),
            Pin(size: 58.0, middle: 0.4363),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  child: Text(
                    'Loamy sand, black soil and even clayey loam is suitable\nfor maize. Both red soil and alluvial are said to be optimal\nfor growing maize. ',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(size: 286.0, start: 28.5),
            Pin(size: 58.0, middle: 0.5345),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 39.0, end: 0.0),
                  child: Text(
                    'Sowing is done generally during June and July months.\nHowever, it is also sown during the months of\nJanuary- February and September – October.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 39.0, end: 0.0),
                  child: Text(
                    'It requires about 70 mm of rainfall. Alternate spells of sunshine\nand rainfall is optimal for maize production.\nIt can tolerate temperature up to 35⁰C.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(start: 28.5, end: 47.5),
            Pin(size: 45.0, middle: 0.7184),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  child: Text(
                    'Andhra Pradesh, Karnataka, Rajasthan, Maharashtra, Bihar,\nUttar Pradesh, Madhya Pradesh, Himachal Pradesh.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(start: 28.5, end: 31.5),
            Pin(size: 45.0, middle: 0.7979),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 26.0, end: 0.0),
                  child: Text(
                    'Methyl demeton, Carbofuran 3%, Dimethoate 30%EC,\nMethyl demeton 25% EC 1000 ml/ha, Phorate 10%CG 10 kg/ha.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      color: const Color(0xff004869),
          ...
          Pinned.fromPins(
            Pin(start: 28.5, end: 36.5),
            Pin(size: 54.0, end: 85.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text:
                              'The Estimated Yield Of Wheat Was 2965 Kg/Hectare\n',
                          style: TextStyle(
                            fontWeight: FontWeight.w500,
                          ),
                        ),
                        TextSpan(
                          text:
                              'MSP has been announced as Rs 1870 per quintal for this crop year\n2021-2022 from Rs 1850 per quintal.',
                          style: TextStyle(
                            fontSize: 9,
